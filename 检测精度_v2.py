...
class WideResNet(nn.Module):
    def __init__(self, depth=28, widen_factor=4, dropout_rate=0.4, num_classes=102):
...
def evaluate_checkpoint(checkpoint_path, data_dir, num_classes=None):
    ...
    # 评估模型
    print("\n在测试集上评估模型...")
    test_accuracy, preds, labels, probs, class_accuracies = evaluate_model(model, dataloaders['test'], class_names,
                                                                           device)
